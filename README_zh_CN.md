...
思源AI图片编辑器是一款为思源笔记设计的轻量级AI图片编辑插件，让你可以直接在笔记中对图片进行标注、涂鸦、裁剪、翻转、色调、AI修图等操作，无需借助外部工具。最大的亮点是AI智能修图和保存为可编辑的项目（支持再次编辑和共享编辑状态）。
![效果预览](https://b3logfile.com/file/2025/12/image-Xy3bg3n.png?imageView2/2/interlace/1/format/webp)
...
- ​**插入图片**：在当前图片上叠加其他图片
- ​**色调调整**：调整图片色调、亮度、饱和度等
![色调调整](https://b3logfile.com/file/2026/01/PixPin_2026-01-18_17-21-05-ZMAlFCa.png?imageView2/2/interlace/1/format/webp)
- ​**AI修图**：可以对图片进行 AI 修图，有时效果更佳
![AI修图](https://b3logfile.com/file/2026/01/PixPin_2026-01-21_16-28-16-PpXOHZb.png?imageView2/2/interlace/1/format/webp)
...
- ​**图片压缩**：可选开启压缩以减小文件体积
- ​**复制到剪贴板**：快速复制编辑结果
- ​**保存/载入项目**：可以保存为可编辑的项目，下次编辑时可通过加载项目文件进行再次编辑
![保存/载入项目](https://b3logfile.com/file/2025/12/image-krCHurE.png?imageView2/2/interlace/1/format/webp)
...
- 升级 VIP 可解锁：
  ...
  - ✅ 批量处理图片（即将推出）
  - ✅ 图片美化和特效功能（已部分推出）
  - ✅ 工具支持，抠图、去水印、OCR等（即将推出）
  - ✅ VIP专属通道：技术问题优先受理，功能需求优先进入开发队列
  - ✅ 不定期发放福利（需要加入QQ群）
